...
### 4.5 Backup & restore coverage (migration `0008_backup_sector_support.sql`)
...
### 4.7 Deferred / not yet implemented
...
> Cross-reference: [Section 4.5](#45-backup--restore-coverage-migration-0008_backup_sector_supportsql) covers backup parity for the sector tables.
